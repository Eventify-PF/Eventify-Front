...
const Carrusel = () => {
    ...
    const images = [
        {
            url: 'https://indiehoy.com/wp-content/uploads/2023/03/green-day.jpg',
        },
        {
            url:'https://upload.wikimedia.org/wikipedia/commons/8/8b/Charly_garcia_by_hildalizarazu.jpg'
        },
        {
            url: 'https://indiehoy.com/wp-content/uploads/2023/03/green-day.jpg',
        },
